...
array.forEach((elem) => console.log(elem * 2))   // перебирает все элементы массива и для каждого элемента будет вызывать колбек функцию которую записали в скобках. не мутирует оригинальный массив. сам метод ниего не возвращает (undefined)
